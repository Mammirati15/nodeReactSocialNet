  ...
  renderPost = (post) => {
    ...
    return (
        <div className="card-body">
          ...
          {like ? (
            <h3 onClick={this.likeToggle}><i className="fa fa-thumbs-down text-warning bg-light" style={{padding: '10px', borderRadius: '50%'}}></i>{" "}{likes} Like</h3>
          ) : (
            <h3 onClick={this.likeToggle}><i className="fa fa-thumbs-up text-success bg-light" style={{padding: '10px', borderRadius: '50%'}}></i>{" "}{likes} Like</h3>
          )}
